...
<body class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans overflow-x-hidden transition duration-500 ease-in-out">
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10">
                @foreach ($projects as $project)
                    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 hover:-translate-y-2 transition transform duration-300 hover:shadow-2xl dark:hover:shadow-blue-500/50" data-aos="zoom-in">
                        <lottie-player
                        ...
                        <h4 class="text-2xl font-semibold mb-3 text-blue-700 dark:text-blue-300">{{ $project['title'] }}</h4>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">{{ $project['description'] }}</p>
                        <a href="{{ $project['link'] }}" class="text-md font-medium text-indigo-600 dark:text-indigo-400 hover:underline flex items-center justify-center space-x-2">
            ...
            <div class="text-center mt-12">
                <p class="text-gray-600 dark:text-gray-400 text-lg">
                    Check out my <a href="YOUR_GITHUB_PROFILE" target="_blank" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline">GitHub profile</a> for more repositories.
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="max-w-5xl mx-auto py-20 px-6 text-center" data-aos="fade-up">
        ...
        <a href="mailto:azinphyoe@example.com" class="bg-blue-600 text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl hover:bg-blue-700 hover:scale-105 transition-transform duration-300">
        ...
        <div class="flex justify-center mt-12 space-x-6">
            ...
            <a href="YOUR_GITHUB_URL" target="_blank" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 transition">GitHub</a>
        </div>
    </section>
